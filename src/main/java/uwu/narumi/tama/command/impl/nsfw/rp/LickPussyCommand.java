...
@CommandInfo(
        alias = "lickpussy",
        description = "?",
        usage = "/lickpussy <person (mention)>",
        type = CommandType.NSFW,
        argsLength = 1
)
public class LickPussyCommand extends Command implements NekosLifeGrabber {

    private static final String URL = "https://img1.gelbooru.com//images/af/7c/af7c85749b1190a7f2f302346a498f98.gif";

    public LickPussyCommand() {
        super(
