...
@CommandInfo(
        alias = "konachan",
        description = "Shows random image from konachan",
        usage = "/konachan [tags] [rating] | /konachan $search",
        type = CommandType.ANIME,
        aliases = "kc"
)
public class KonachanCommand extends Command implements BooruGrabber {

    private final String url = "https://konachan.com/post.xml?" +
            "page=0" +
            "&limit=100" +
            "&tags=%s";
