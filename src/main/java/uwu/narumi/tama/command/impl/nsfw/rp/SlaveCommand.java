...
@CommandInfo(
        alias = "slave",
        description = "?",
        usage = "/slave <person (mention)>",
        type = CommandType.NSFW,
        argsLength = 1
)
public class SlaveCommand extends Command implements NekosLifeGrabber {

    private static final String URL = "https://img1.gelbooru.com//images/dd/ab/ddab4db94cf9517fa75483891515787a.gif";
